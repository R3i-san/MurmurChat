...
class MainWindow:
    def __init__(self, controller):
        ...
        self.host = tk.StringVar(value="laurent.godswila.guru")
        self.passw = tk.StringVar(value="test")
        self.login = tk.StringVar(value="Laurent")
        self.tls = tk.BooleanVar()
        self.port = tk.IntVar(value=23103)
